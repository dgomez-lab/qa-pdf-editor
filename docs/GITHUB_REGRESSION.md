...
| Sin screenshots en fallos del dashboard | Artefactos `failure-artifacts-*` no descargados o merge antiguo que solo buscaba `failure-screenshots/` | Mismo merge actual; artefactos ya suben PNG + `manifest.ndjson` |
