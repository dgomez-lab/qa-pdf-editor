...
function resolveStepText(testStepId, testCase, pickleStepText) {
  const pickleStepId = (testCase?.testSteps || []).find((step) => step.id === testStepId)?.pickleStepId
...
export { walkSuites, isHookStepId, resolveStepText, parseCucumberFailures, buildMarkdown }
